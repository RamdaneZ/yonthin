                ...
                @else
                    <div>
                        <form action="{{ url('sendmessage') }}" method="POST" class="contact-form style2">
                            @csrf
                            <h3 class="sec-title mb-30 text-capitalize">Yonthin team is ready for your message!</h3>
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <input type="text" class="form-control" name="address" id="name" placeholder="Address"> <img src="assets/img/icon/map.svg" alt="">
                                </div>
