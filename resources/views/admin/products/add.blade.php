                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <script>
                                    ...
                                    // Ajouter une nouvelle ligne à une colonne spécifique dans un tableau spécifique
                                    function addRow(tableIndex, columnIndex) {
                                        let rowCount = document.querySelectorAll(`#rows_${tableIndex + 1}_${columnIndex}`).length;
                                        let newRow = `
                                            <div class="row mb-2">
                                                <div class="col-md-4">
                                        ...
                                        `;
                                        document.getElementById(`rows_${tableIndex + 1}_${columnIndex}`).insertAdjacentHTML('beforeend', newRow);
                                    }
                                </script>
