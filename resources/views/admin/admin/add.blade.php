        ...
        <div class="row">
            <div class="col-9">
                <div class="content-header">
                    <h2 class="content-title">Nouveau administrateur</h2>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="mt-3" method="POST" action="{{ url('admin/admin/store') }}">
                            @csrf
                            <div class="row">
                              <div class="col-lg-12">
                                <div class="row gx-3">
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input name="username" class="form-control" type="text" placeholder="Entrer nom d'utilisateur ici" required>
                                    </div>
                                    <div class="col-lg-6 mb-3">
