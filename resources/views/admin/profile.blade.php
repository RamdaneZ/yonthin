          ...
          <div class="row gx-5">
            <div class="col-lg-12">
              <section class="content-body p-xl-4">
                <form method="POST" action="{{ url('admin/editprofile') }}">
                  @csrf
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="row gx-3">
                        ...
                        <div class="col-lg-6 mb-3">
                          ...
                          <input name="new_password" class="form-control" type="password" placeholder="Entrer nouveau mot de passe ici">
                        </div>
                        <hr>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6 mb-3">
                      ...
                      <input name="password" class="form-control" type="password" placeholder="Entrer mot de passe ici" required>
                  </div>
